...
//HEREDA de 'ViewModel' para sobrevivir a cambios de configuración y tener acceso al 'viewModelScope'.
class PostViewModel : ViewModel() {

    // 1. OBTENER ACCESO AL REPOSITORIO
    //    El ViewModel necesita el Repositorio para pedirle los datos.
    ...
    val isLoading: StateFlow<Boolean> = _isLoading // La UI observará este para mostrar/ocultar un spinner.
