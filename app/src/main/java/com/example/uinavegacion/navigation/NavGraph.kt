...
import com.example.uinavegacion.ui.screen.CatalogoProductosScreen // Pantalla Catálogo (nueva)
import com.example.uinavegacion.ui.screen.PasswordResetScreen // Pantalla Reset Password
import com.example.uinavegacion.ui.screen.CategoriesScreen // Pantalla Categorías
...
fun AppNavGraph(navController: NavHostController,
    ...
    val goCatalogo: () -> Unit = { navController.navigate(Route.Catalogo.path) } // Ir a Catálogo
    val goPasswordReset: () -> Unit = { navController.navigate(Route.PasswordReset.path) } // Ir a Reset Password
    val goCategories: () -> Unit = { navController.navigate(Route.Categories.path) } // Ir a Categorías
        ...
        Scaffold( // Estructura base de pantalla
            topBar = { // Barra superior con íconos/menú
                AppTopBar(
                    ...
                    onPasswordReset = goPasswordReset, // Botón Reset Password
                    onCatalogo = goCatalogo // Botón Catálogo
                )
            }
            ...
            NavHost( // Contenedor de destinos navegables
                ...
                composable(Route.Home.path) { // Destino Home
                    HomeScreen(
                        ...
                        onGoCatalogo = goCatalogo,  // Botón para ir a Catálogo
                ...
                // Destino Reset Password
                composable(Route.PasswordReset.path) {
                    PasswordResetScreen(
                        onGoLogin = goLogin,
                        onPasswordResetSent = { /* TODO: implementar lógica post-envío */ }
                    )
                }
                ...
                composable(Route.Categories.path) {
                    CategoriesScreen(
                        onCategoryClick = { category ->
                            // TODO: implementar navegación a productos de la categoría
                            // navController.navigate("category/${category.id}/products")
                        }
                    )
                }
            }
