...
fun HomeScreen(
    ...
    onGoCatalogo: () -> Unit = {}, // Acción a Catálogo
    onGoCategories: () -> Unit = {} // Acción a Categorías
) {
    val context = LocalContext.current
    val userPrefs = remember { UserPreferences(context) }
    val isLoggedIn by userPrefs.isLoggedIn.collectAsStateWithLifecycle(false)

    //variable para almacenar la ultima foto tomada con la camara
    var photoUriString by rememberSaveable { mutableStateOf<String?>(null) }
    //var la que use la camara para tomar la foto
    var pendingCaptureUri by remember { mutableStateOf<Uri?>(null) }

    //launcher para abrir la camara
        ...
        Box( // Contenedor a pantalla completa
            ...
            Column( // Estructura vertical
                ...
                Row(
                    ...
                    //UI para el cambio de datos a partir del Data Store
                    Icon(
                ...
                ElevatedCard(
                    ...
                    Column(
                        ...
                        //estado para mostrar o no alert
                ...
                // Botones para Catálogo y Categorías
                Row(
